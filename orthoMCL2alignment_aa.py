...
_mkdir("pairwise_orthologs_aa")
_mkdir("4_species_orthologs_aa")
_mkdir("pairwise_orthologs_aligned_aa")
_mkdir("4_species_orthologs_aligned_aa")
...
for Line in orthomcl_output:
	...
	if len(genes)==4:
		...
		seq_gene1=gene1[1]
		if sp_gene1=="Amur":
			file1="Amuricata_CDS_aa.fasta"
		elif sp_gene1=="Atri":
			file1="Amborella_trichopoda_CDS_aa.fasta"
		elif sp_gene1=="Atha":
			file1="Arabidopsis_thaliana_CDS_aa.fasta"
		elif sp_gene1=="Osat":
			file1="Oryza_sativa_CDS_aa.fasta"

		gene2=genes[1].split('|')	
		sp_gene2=gene2[0]
		seq_gene2=gene2[1]
		if sp_gene2=="Amur":
			file2="Amuricata_CDS_aa.fasta"
		elif sp_gene2=="Atri":
			file2="Amborella_trichopoda_CDS_aa.fasta"
		elif sp_gene2=="Atha":
			file2="Arabidopsis_thaliana_CDS_aa.fasta"
		elif sp_gene2=="Osat":
			file2="Oryza_sativa_CDS_aa.fasta"
		gene3=genes[2].split('|')
		sp_gene3=gene3[0]
		seq_gene3=gene3[1]
		if sp_gene3=="Amur":
			file3="Amuricata_CDS_aa.fasta"
		elif sp_gene3=="Atri":
			file3="Amborella_trichopoda_CDS_aa.fasta"
		elif sp_gene3=="Atha":
			file3="Arabidopsis_thaliana_CDS_aa.fasta"
		elif sp_gene3=="Osat":
			file3="Oryza_sativa_CDS_aa.fasta"

		gene4=genes[3].split('|')	
		sp_gene4=gene4[0]
		seq_gene4=gene4[1]
		if sp_gene4=="Amur":
			file4="Amuricata_CDS_aa.fasta"
		elif sp_gene4=="Atri":
			file4="Amborella_trichopoda_CDS_aa.fasta"
		elif sp_gene4=="Atha":
			file4="Arabidopsis_thaliana_CDS_aa.fasta"
		elif sp_gene4=="Osat":
			file4="Oryza_sativa_CDS_aa.fasta"
		...
		if (sp_gene1 != sp_gene2) and (sp_gene4 != sp_gene3) and (sp_gene2 != sp_gene4) and (sp_gene1 != sp_gene3) and (sp_gene1 != sp_gene4) and (sp_gene2 != sp_gene3):
			unaligned_file="4_species_orthologs_aa/group" + str(group)+".fasta"
			...
			aligned_file="4_species_orthologs_aligned_aa/group" + str(group)+".fasta"
	...
	#### Then for each pair of orthologs
		...
		if (sp_gene1 != sp_gene2):
			unaligned_file="pairwise_orthologs_aa/group" + str(group)+".fasta"
			...
			mafft_cline.adjustdirection = True
			stdout, stderr = mafft_cline()
			aligned_file="pairwise_orthologs_aligned_aa/group" + str(group)+".fasta"
			outfile = open (aligned_file, 'w')
			outfile.write(stdout)
			outfile.close()
